package com.xyzla.netty.user.guide.demo.codec.jackcon;
...
public class JsonGeneratorDemo {
	...
	public static void main(String[] args) throws IOException {
		try {
			...
			JsonGenerator jGenerator = jfactory.createJsonGenerator(new FileOutputStream(FILE_PATH), JsonEncoding.UTF8);
